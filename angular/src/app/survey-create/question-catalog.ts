...
export const QUESTION_CATALOG: QuestionDef[] = [
  { type: 'singleChoice', title: 'Multiple Choice', sub: 'Single Answer', icon: 'lucide:check-square' },
  ...
  { type: 'multiSelect',  title: 'Multi-select',    sub: 'Chips',          icon: 'lucide:badge-plus' },
